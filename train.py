...
def main():
    ...
    while global_step < args.num_steps:
        for _ in range(min(total_steps, args.num_steps - global_step)):
            ...
            l2_loss_scale = linear_scale if no_im_loss else compute_scale(args.l2_loss_scale, args.l2_loss_ramp, global_step)
            lpips_loss_scale = linear_scale if no_im_loss else compute_scale(args.lpips_loss_scale, args.lpips_loss_ramp, global_step)
            G_loss_scale = linear_scale if no_im_loss else compute_scale(args.G_loss_scale, args.G_loss_ramp, global_step)
